package org.tent.common.utils.collection.type;

import static org.assertj.core.api.Assertions.*;

import org.assertj.core.api.Assertions;
import org.junit.Test;
import org.tent.common.utils.collection.SetUtil;
...
public class ConcurrentHashSetTest {
	...
	public void concurrentHashSet() {
		...
		Assertions.assertThat(conrrentHashSet).hasSize(3).contains("a", "b", "c");
		...
		Assertions.assertThat(conrrentHashSet).hasSize(2);
		...
		Assertions.assertThat(conrrentHashSet).hasSize(1).contains("a");
